  ...
  Future<void> _takeSelfie() async {
    ...
    if (image != null) {
      ...
      try {
        ...
        // Aqui deberias buscar la URL de tu repositorio real/Supabase correspondiente a ese ID.
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                'Gemini recomendo el ID de prenda: ${widget.prompt}',
            ...
            if (_userSelfie == null) ...[
              ...
              ElevatedButton(
                ...
                child: const Text('Tomate una foto para probarte la ropa'),
              ),
            ] else ...[
              if (_isGenerating) ...[
